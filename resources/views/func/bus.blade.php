...
<main>
    ...
    @guest
        ...
        @endguest
        @auth
        <h1 class="text-center mt-3">Pembelian Tiket Bus</h1>
        <!-- Section: Search -->
        ...
        <div class="m-4 w-100" style="color: black;">
            <div class="d-flex gap-4">
                <div class="d-lg-block w-100" style="max-height: 475px;">
                                <!-- Section: Map -->
                        ...
                        <div class="d-flex flex-column w-100 pb-4" style="max-height: 540px;">
                            <!-- Section: tiket form -->
                            <div class="card m-0" style="max-width: 1460px; align-item: center; padding: 10px;">
                                ...
                                <img src="/images/bus.jpeg" class="card-img-bottom img-fluid h-100 pb-3 px-1 rounded m-auto" style="max-height: 200px; max-width: 400px" alt="bus"/>
                              </div>
                        </div>
                    </div>
