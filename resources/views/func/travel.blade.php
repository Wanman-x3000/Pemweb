...
<main>
    ...
    @guest
        ...
        @endguest
        @auth
        <h1 class="text-center mt-3">Pembelian Tiket Shuttle Bus</h1>
        <!-- Section: Search -->
        ...
        <div class="m-4 w-100" style="color: black;">
            <div class="d-flex gap-4">
                <div class="d-flex flex-column w-100 pb-4" style="max-height: 620px;">
                    <!-- Section: tiket form -->
                    <div class="card m-0" style="max-width: 1460px; align-item: center; padding: 10px;">
                        ...
                        <img src="/images/travel3.png" class="card-img-bottom img-fluid w-100 pb-3 px-1 rounded m-auto" style="max-height: 280px; max-width: 580px" alt="bus"/>
                      </div>
                </div>
                <div class="d-lg-block w-100" style="max-height: 545px;">
                                <!-- Section: Map -->
